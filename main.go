...
// 		c.HTML(http.StatusOK, "form.html", gin.H{"ClinicName": getDisplayClinicName(c), "ClinicTitle": getDisplayClinicName(c)})
// 	}))
...
// 		c.HTML(http.StatusOK, "invoice_search_by_id.html", gin.H{"ClinicName": getDisplayClinicName(c), "ClinicTitle": getDisplayClinicName(c)})
// 	}))
